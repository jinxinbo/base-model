...
class AdalrModel(object):
    ...
    def fit_for_best_cls(self, feature_values, target_values):
        ...
        ada = sklearn.ensemble.AdaBoostClassifier(base_estimator = lr)
        
        #model_params = {"n_estimators" : [100, 150, 200], "learning_rate" : [0.01, 0.1]}
        model_params = {"n_estimators" : [100], "learning_rate" : [1.0]}
    ...
    def get_model_detail(self):
        ...
        detail["model_name"] = "AdaBoost with LR"
